...
class DetailDitolakPage extends StatelessWidget {
  final String serviceName;
  final String areaId;

  const DetailDitolakPage({
    super.key,
            ...
            child: StreamBuilder<List<Request>>(
              ...
              builder: (context, snapshot) {
                ...
                final list = snapshot.data!
                    .where((r) => r.serviceName == serviceName && r.status?.toLowerCase() == 'ditolak')
                    .toList();

                if (list.isEmpty) {
                  return const Center(
                    child: Text("Belum ada warga dengan pengajuan ditolak untuk kategori ini."),
                  );
                }
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                context.go('/rt/detail_data/pengajuan/ditolak?id=${pengajuan.id}');
                              },
