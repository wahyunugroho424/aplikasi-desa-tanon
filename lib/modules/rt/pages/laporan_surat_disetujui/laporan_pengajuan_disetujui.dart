...
class LaporanPengajuanDisetujui extends StatefulWidget {
  const LaporanPengajuanDisetujui({super.key});

  @override
  State<LaporanPengajuanDisetujui> createState() => _LaporanPengajuanDisetujuiState();
}

class _LaporanPengajuanDisetujuiState extends State<LaporanPengajuanDisetujui> {
