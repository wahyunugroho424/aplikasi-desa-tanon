...
class DetailDisetujuiPage extends StatelessWidget {
  final String serviceName;
  final String areaId;

  const DetailDisetujuiPage({
    super.key,
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            // 🔹 TAB KIRI: Kategori Surat
                            Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  context.go('/rt/laporan');
                                },
                                child: Container(
          ...
          // ===== LIST DETAIL PENGAJUAN DISETUJUI =====
          Expanded(
            child: StreamBuilder<List<Request>>(
              ...
              builder: (context, snapshot) {
                ...
                final list = snapshot.data!
                    .where((r) => r.serviceName == serviceName && r.status?.toLowerCase() == 'disetujui')
                    .toList();

                if (list.isEmpty) {
                  return const Center(
                    child: Text("Belum ada warga dengan pengajuan disetujui untuk kategori ini."),
                  );
                }
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: FutureBuilder<String>(
                                ...
                                builder: (context, nameSnapshot) {
                                  final username = nameSnapshot.data ?? 'Memuat...';
                                  return Column(
                            ...
                            // 🔹 Tombol kanan (cek detail)
                            ElevatedButton(
                              onPressed: () {
                                context.go('/rt/detail_data/pengajuan/disetujui?id=${pengajuan.id}');
                              },
