...
class BeritaRTDetailPage extends StatefulWidget {
  final String newsId; 
  const BeritaRTDetailPage({super.key, required this.newsId});

  @override
  State<BeritaRTDetailPage> createState() => _BeritaRTDetailPageState();
}

class _BeritaRTDetailPageState extends State<BeritaRTDetailPage> {
  News? news;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        // 🔹 Paksa default back ke '/rt/berita'
        _defaultBackRoute = extra['from'] ?? '/rt/berita';
      });
    });
  }
